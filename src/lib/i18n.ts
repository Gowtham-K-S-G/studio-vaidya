...
export const translations = {
  English: {
    dashboard: {
      ...
      reminders: {
        title: 'Notifications',
        description: "Your latest alerts and reminders.",
  ...
  Kannada: {
    dashboard: {
      ...
      reminders: {
        title: 'ಸೂಚನೆಗಳು',
        description: "ನಿಮ್ಮ ಇತ್ತೀಚಿನ ಎಚ್ಚರಿಕೆಗಳು ಮತ್ತು ಜ್ಞಾಪನೆಗಳು।",
        noNotifications: "ನಿಮಗೆ ಯಾವುದೇ ಹೊಸ ಸೂಚನೆಗಳಿಲ್ಲ।",
  ...
  Hindi: {
    dashboard: {
      ...
      reminders: {
        title: 'सूचनाएं',
        description: "आपके नवीनतम अलर्ट और अनुस्मारक।",
        noNotifications: "आपके पास कोई नई सूचनाएं नहीं हैं।",
  ...
  Tamil: {
    dashboard: {
      ...
      reminders: {
        title: 'அறிவிப்புகள்',
        description: "உங்கள் சமீபத்திய எச்சரிக்கைகள் மற்றும் நினைவூட்டல்கள்।",
